...
<html>
	...
	<div class="table">
	<form method="post" action="mebill.php">
	<?php
		...
		{
			$sql="select * from medicalequipments";
			...
			while($row=mysqli_fetch_array($rs))
			{
				...
				<td align=center><input type=number name=q$i value=$row[3] max=10 min=0></td>
				<td align=center><input type=text name=c$i value=$row[4] readonly></td>";
			...
			echo"<input type=submit value=SUBMIT name=btn>";
		}
	?>
		</form>
		</div>
